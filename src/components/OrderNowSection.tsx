...
const OrderNowSection = () => {
  return (
    <aside className="-mt-4 p-3 bg-slate-100 max-lg:mt-5">
      <h4 className="font-medium text-lg text-center max-lg:text-start max-lg:underline underline-offset-2">
        Shipping Details
      </h4>
      <div className="leading-tight space-y-2 mt-2">
        <p className="flex gap-x-1">
          <FaRegCircleCheck className="w-5 h-5 flex-shrink-0 text-primary-green" />
        ...
        <p className="flex gap-x-1">
          <FaRegCircleCheck className="w-5 h-5 flex-shrink-0 text-primary-green" />
          Pay with a secure payment for all your orders
        </p>
      </div>
